...
fn shader(extent: Extent<2>, time: f32) -> Tensor<u32, 2> {
    extent
        ...
        .map(|(x, y)| {
            ...
            let px: f32 = ((x as f32 + 0.5) * 2.0 - extent[0] as f32) / extent[1] as f32;
            let py: f32 =
                (((extent[1] - 1 - y) as f32 + 0.5) * 2.0 - extent[1] as f32) / extent[1] as f32;
